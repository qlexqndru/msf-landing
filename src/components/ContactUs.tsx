        ...
        <div className="max-w-4xl">
          ...
          <div className="border-t border-blue-400/30 pt-8">
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="p-3 rounded-full transition-all duration-200 hover:scale-110" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }} onMouseEnter={(e) => (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(255,255,255,0.3)'} onMouseLeave={(e) => (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(255,255,255,0.2)'}>
